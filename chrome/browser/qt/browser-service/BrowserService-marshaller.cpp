...
void
browser_service_marshal_VOID__INT64_STRING_STRING_STRING (GClosure     *closure,
...
{
  typedef void (*GMarshalFunc_VOID__INT64_STRING_STRING_STRING) (gpointer     data1,
                                                                 gint64       arg_1,
                                                                 gpointer     arg_2,
                                                                 gpointer     arg_3,
                                                                 gpointer     arg_4,
...
void
browser_service_marshal_VOID__INT64 (GClosure     *closure,
                                     GValue       *return_value G_GNUC_UNUSED,
                                     guint         n_param_values,
                                     const GValue *param_values,
                                     gpointer      invocation_hint G_GNUC_UNUSED,
...
void
browser_service_marshal_VOID__STRING_UINT (GClosure     *closure,
                                           GValue       *return_value G_GNUC_UNUSED,
                                           guint         n_param_values,
                                           const GValue *param_values,
                                           gpointer      invocation_hint G_GNUC_UNUSED,
