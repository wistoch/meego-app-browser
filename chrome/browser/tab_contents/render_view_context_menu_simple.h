...
#ifndef CHROME_BROWSER_TAB_CONTENTS_RENDER_VIEW_CONTEXT_MENU_SIMPLE_H_
#define CHROME_BROWSER_TAB_CONTENTS_RENDER_VIEW_CONTEXT_MENU_SIMPLE_H_
#pragma once
...
class RenderViewContextMenuSimple : public ui::SimpleMenuModel::Delegate {
 public:
  static const size_t kMaxExtensionItemTitleLength;
  static const size_t kMaxSelectionTextLength;

  RenderViewContextMenuSimple(TabContents* tab_contents,
                        const ContextMenuParams& params);

  virtual ~RenderViewContextMenuSimple();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RenderViewContextMenuSimple);
};

#endif  // CHROME_BROWSER_TAB_CONTENTS_RENDER_VIEW_CONTEXT_MENU_SIMPLE_H_
